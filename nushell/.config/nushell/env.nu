...
$env.BASH_COMPLETION_USER_FILE = ($env.XDG_CONFIG_HOME | path join "bash-completion" "bash_completion")
...
$env.COPILOT_HOME = ($env.XDG_CONFIG_HOME | path join "copilot")
$env.CUDA_CACHE_PATH = ($env.XDG_CACHE_HOME | path join "nv")
$env.DENO_DIR = ($env.XDG_DATA_HOME | path join "deno")
$env.DISCORD_USER_DATA_DIR = $env.XDG_DATA_HOME
...
$env.KDEHOME = ($env.XDG_CONFIG_HOME | path join "kde")
...
$env.PGPASSFILE = ($env.XDG_CONFIG_HOME | path join "pg" "pgpass")
$env.PGSERVICEFILE = ($env.XDG_CONFIG_HOME | path join "pg" "pg_service.conf")
$env.PHP_HISTFILE = ($env.XDG_STATE_HOME | path join "php" "history")
...
$env.PSQLRC = ($env.XDG_CONFIG_HOME | path join "pg" "psqlrc")
...
$env.RLWRAP_HOME = ($env.XDG_DATA_HOME | path join "rlwrap")
$env.RUFF_CACHE_DIR = ($env.XDG_CACHE_HOME | path join "ruff")
$env.RUSTUP_HOME = ($env.XDG_DATA_HOME | path join "rustup")
$env.SOLARGRAPH_CACHE = ($env.XDG_CACHE_HOME | path join "solargraph")
...
$env.TASKDATA = ($env.XDG_DATA_HOME | path join "task")
$env.TASKRC = ($env.XDG_CONFIG_HOME | path join "task" "taskrc")
